...
| --- | --- | --- | --- | --- |
| PR description | Reviewer deciding whether to approve | The wrong behavior, or for a feature, what the user can now do | Headings are fine; a template's required sections stay. Typical: summary, cause, change, testing, notes | Test internals, defended alternatives, restated assurances, praise of the fix |
...
| Slack message | Teammate deciding whether they need to act | The status or the ask | Plain paragraphs, at most a short list. No headings | Background the channel already knows, hedges, sign-off flourishes |
