...
```bash
<dot-cli> off <task-id> -r "Created X implementation dots, documented Y findings"
```
...
```bash
<dot-cli> add "research: <topic>" -d "Questions to answer..."
<dot-cli> add "implement: <feature>" -d "Spec details..."
```
